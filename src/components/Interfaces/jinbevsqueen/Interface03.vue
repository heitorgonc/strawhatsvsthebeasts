<template>
    <div class="panel">
        <b-card-body>
            <div class="score">
                <transition name="flip" mode="out-in">
                    <b-card-img class="playerImg" :src='require("../../../assets/img/Jinbe.png")' fluid v-if="childPlayerHp >= 30"></b-card-img>
                    <JinbeRaged v-if="childPlayerHp < 30 && childPlayerHp > 0"></JinbeRaged>
                    <b-card-img class="playerImg lose" v-if="childPlayerHp == 0" :src='require("../../../assets/img/tobecontinued.png")' fluid></b-card-img>
                </transition>
                <div class="playerName" v-if="childPlayerHp > 0" >Jinbe</div>
            </div>
        ...
        <b-card-body>
            <div class="score">
                <transition name="flip" mode="out-in">
                    <b-card-img class="monsterImg" v-if="childMonsterHp >= 30" :src='require("../../../assets/img/Queen.png")' fluid></b-card-img>
                    <QueenRaged v-else-if="childMonsterHp < 30 && childMonsterHp > 0"></QueenRaged>
                    <b-card-img class="monsterImg lose" v-if="childMonsterHp == 0" :src='require("../../../assets/img/tobecontinued.png")' fluid></b-card-img>
                </transition>
                <div class="monsterName" v-if="childMonsterHp > 0">Queen</div>
            </div>
...
<script>
import JinbeRaged from './JinbeRaged.vue'
import QueenRaged from './QueenRaged.vue'
