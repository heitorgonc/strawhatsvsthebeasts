<template>
    <div class="panel">
        <b-card-body>
            <div class="score">
                <transition name="flip" mode="out-in">
                    <b-card-img class="playerImg" :src='require("../../../assets/img/Zoro.png")' fluid v-if="childPlayerHp >= 30"></b-card-img>
                    <ZoroRaged v-if="childPlayerHp < 30 && childPlayerHp > 0"></ZoroRaged>
                    <b-card-img class="playerImg lose" v-if="childPlayerHp == 0" :src='require("../../../assets/img/tobecontinued.png")' fluid></b-card-img>
                </transition>
                <div class="playerName" v-if="childPlayerHp > 0" >Zoro</div>
            </div>
        ...
        <b-card-body>
            <div class="score">
                <transition name="flip" mode="out-in">
                    <b-card-img class="monsterImg" v-if="childMonsterHp >= 30" :src='require("../../../assets/img/King.png")' fluid></b-card-img>
                    <KingRaged v-else-if="childMonsterHp < 30 && childMonsterHp > 0"></KingRaged>
                    <b-card-img class="monsterImg lose" v-if="childMonsterHp == 0" :src='require("../../../assets/img/tobecontinued.png")' fluid></b-card-img>
                </transition>
                <div class="monsterName" v-if="childMonsterHp > 0">King</div>
            </div>
...
<script>
import ZoroRaged from './ZoroRaged.vue'
import KingRaged from './KingRaged.vue'
